...
Signal Intelligence exports spans — Gemini cognition calls (with token usage)
and Parallel Search retrievals — to Google Cloud Trace on the project's
Google Cloud substrate (locked §9), via the system's ambient ADC credentials.
"""
